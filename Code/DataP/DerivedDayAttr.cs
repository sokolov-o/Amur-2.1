...
namespace FERHRI.Amur.DataP
{
    public class DerivedDayAttr
    {
        ...
        public DerivedDayAttr(int id, string name, int methodId, int stationTypeId, int siteTypeId, int meteoZoneId, int variableId,
            int offsetTypeId, double offsetValue, int srcDateTypeId, int hourAddForStart, bool isIncludeF, int dstDateTypeId)
        {
            Id = id; Name = name; MethodId = methodId; StationTypeId = stationTypeId; SiteTypeId = siteTypeId;
            MeteoZoneId = meteoZoneId; VariableId = variableId; OffsetTypeId = offsetTypeId; OffsetValue = offsetValue;
            SrcDateTypeId = srcDateTypeId; HourAddForStart = hourAddForStart; IsIncludeF = isIncludeF;
